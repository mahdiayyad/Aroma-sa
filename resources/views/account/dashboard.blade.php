    ...
    <div class="row g-4">
        ...
        <div class="col-lg-9">
            <div class="row g-3">
                <div class="col-md-4">
                    <div class="aroma-trust p-4 text-center">
                        <i class="bi bi-gem fs-2 text-aroma-brown"></i>
                        <div class="fs-3 fw-bold">{{ $user->loyalty_points }}</div>
                        <div class="text-aroma-muted small">{{ __('account.stats.points') }}</div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="aroma-trust p-4 text-center">
                        <i class="bi bi-receipt fs-2 text-aroma-brown"></i>
                        <div class="fs-3 fw-bold">0</div>
                        <div class="text-aroma-muted small">{{ __('account.stats.orders') }}</div>
                    </div>
                </div>
                <div class="col-md-4">
                    <a href="{{ route('wishlist.index') }}" class="text-decoration-none">
                        <div class="aroma-trust p-4 text-center">
                            <i class="bi bi-heart fs-2 text-aroma-brown"></i>
                            <div class="fs-3 fw-bold">{{ $wishlistCount }}</div>
                            <div class="text-aroma-muted small">{{ __('account.stats.wishlist') }}</div>
                        </div>
                    </a>
                </div>
            </div>
            ...
            <div class="aroma-trust p-4 mt-4">
                ...
                <p class="text-aroma-muted mb-0">{{ __('account.no_orders') }}</p>
            </div>
        </div>
    </div>
</div>
