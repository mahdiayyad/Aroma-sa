...
return [
    ...
    'manual' => [
        ...
        'apartment_number' => 'Apartment / Unit (optional)',
        'postal_code' => 'Postal Code',
        'additional_notes' => 'Additional Notes (optional)',
        'building_short' => 'Bldg :number',
    ...
    'errors' => [
        ...
        'required_one' => 'Please enter a National Address code or a full address.',
    ],
];
